...
var TweenOneGroup = function (_Component) {
  ...
  function TweenOneGroup(props) {
    ...
    _this.originalChildren = toArrayChildren(getChildrenFromProps(_this.props));
  ...
  _createClass(TweenOneGroup, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var currentChildren = toArrayChildren(nextProps.exclusive ? this.originalChildren : this.state.children);
